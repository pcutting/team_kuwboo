              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.music_note_rounded, size: 28, color: theme.primary),
                    ),
                ...
                GridView.count(
                  ...
                  children: List.generate(9, (i) => GestureDetector(
                    ...
                    child: Container(
                      color: theme.primary.withValues(alpha: 0.1 + (i * 0.05)),
                      child: Center(child: Icon(theme.icons.playArrow, size: 20, color: theme.textTertiary)),
                    ),
                  )),
                ),
              ],
