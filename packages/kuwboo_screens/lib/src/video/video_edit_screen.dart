...
class _VideoEditScreenState extends State<VideoEditScreen> {
  ...
  Future<void> _handlePost() async {
    ...
    if (confirmed && mounted) {
      ProtoToast.show(context, ProtoTheme.of(context).icons.checkCircle, 'Video posted!');
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                GestureDetector(
                  onTap: _handleBack,
                  child: Icon(theme.icons.arrowBack, size: 20, color: Colors.white),
                ),
                const Spacer(),
                Text('Edit', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
                const Spacer(),
                ProtoPressButton(
                  onTap: _handlePost,
                  child: Container(
                    ...
                    child: Text('Post', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.white)),
                  ),
                ),
              ],
            ),
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Center(
                child: Icon(theme.icons.playCircleOutline, size: 48, color: Colors.white.withValues(alpha: 0.3)),
              ),
            ),
          ),
            ...
            builder: (context, constraints) {
              return GestureDetector(
                onHorizontalDragUpdate: (details) {
                  setState(() {
                    _scrubberPosition = (details.localPosition.dx / constraints.maxWidth).clamp(0.0, 1.0);
                  });
                },
                onTapDown: (details) {
                  setState(() {
                      ...
                      Row(
                        children: List.generate(8, (i) => Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white.withValues(alpha: 0.15 + (i * 0.05)),
            ...
            child: Row(
              ...
              children: List.generate(_toolLabels.length, (i) {
                ...
                return ProtoPressButton(
                  onTap: () {
                    setState(() => _selectedTool = _selectedTool == i ? -1 : i);
                    if (label == 'Sound') {
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(icon, size: 20, color: isSelected ? theme.primary : Colors.white),
                      ),
          ...
          Container(
            ...
            child: Row(
              children: [
                GestureDetector(
                  onTap: () => ProtoToast.show(context, theme.icons.edit, 'Caption editor would open'),
                  child: Text('Add caption...', style: TextStyle(color: Colors.white54, fontSize: 14)),
                ),
                const Spacer(),
                GestureDetector(
                  onTap: () => ProtoToast.show(context, theme.icons.tag, 'Tag suggestions would appear'),
                  child: Text('#tags', style: TextStyle(color: theme.primary, fontSize: 13, fontWeight: FontWeight.w500)),
                ),
              ],
            ),
          ),
